...
const BorrowerDashboard = () => {
  ...
  const mockPaymentHistory = [
    ...
    },
    {
      ...
      type: "Principal + Interest",
      status: "Completed",
      txHash: "0x1B0c9D8e7F6a5B4c3D2e1F0a9B8c7D6e5F4a3B2c1D0e9F8a7B6c5D4e3F2a1B0"
    },
    {
      id: "pay_004",
      date: "09/28/2025",
    ...
    },
    {
      ...
      type: "Principal + Interest",
      status: "Pending",
      txHash: "0x5D4e3F2a1B0c9D8e7F6a5B4c3D2e1F0a9B8c7D6e5F4a3B2c1D0e9F8a7B6c5D4"
    }
  ];
  ...
  const handleMakePayment = (loan) => {
    navigate('/payment-processing', { state: { loan } });
  };
  ...
  const handlePayNow = (payment) => {
    navigate('/payment-processing', { state: { payment } });
  };

  return (
    <>
      <Helmet>
        <title>Borrower Dashboard - DeFiLoan</title>
        <meta name="description" content="Manage your loans, track payments, and monitor credit score on DeFiLoan platform" />
      </Helmet>
      <Header />
