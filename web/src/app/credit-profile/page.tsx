    ...
    <div className="min-h-screen bg-background pt-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8 lg:py-12">
        ...
        <div className="bg-card border border-border rounded-xl p-8 text-center">
          <AppIcon name="TrendingUp" size={48} className="text-muted-foreground/30 mx-auto mb-4" />
          <h1 className="text-2xl font-semibold text-foreground mb-2">Credit Profile</h1>
          <p className="text-muted-foreground">Credit profile page coming soon...</p>
        </div>
      </div>
    </div>
  );
