...
const PaymentSummaryCard = ({ loanData, paymentAmount, interestAmount, remainingBalance } : PaymentSummaryProps) => {
  return (
    <div className="bg-card border border-border rounded-xl p-4 md:p-6 lg:p-8 shadow-glow-md">
      ...
      <div className="space-y-3 md:space-y-4">
        <div className="flex items-center justify-between py-3 border-b border-border">
          ...
          <span className="text-base md:text-lg font-semibold text-foreground">${loanData?.loanAmount?.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
        </div>
