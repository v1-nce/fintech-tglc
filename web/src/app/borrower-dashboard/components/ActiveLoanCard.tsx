...
export default function ActiveLoanCard({ loan, onMakePayment }: ActiveLoanCardProps) {
    ...
    <div className="bg-card border border-border rounded-xl p-4 md:p-6 shadow-glow-md">
      ...
      <div className="mb-4 md:mb-6">
        ...
        <div className="w-full h-2 bg-muted/30 rounded-full overflow-hidden">
          <div className="h-full bg-primary rounded-full transition-all duration-500" style={{ width: `${calculateProgress()}%` }} />
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-4 md:mb-6">
        <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
          <AppIcon name="Percent" size={18} className="text-primary" />
          <div>
        ...
        <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-lg">
          <AppIcon name="Calendar" size={18} className="text-primary" />
          <div>
      ...
      <div
        className={`flex items-center gap-2 p-3 md:p-4 rounded-lg mb-4 ${
      ...
      >
        ...
        <div className="flex-1">
          ...
          <div
            className={`text-sm md:text-base font-medium ${isOverdue ? 'text-error' : isUrgent ? 'text-warning' : 'text-foreground'}`}
          >
