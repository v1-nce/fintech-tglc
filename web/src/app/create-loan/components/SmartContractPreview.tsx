...
export default function SmartContractPreview({
  loanAmount,
  interestRate,
  loanTerm,
  minCreditScore,
    ...
    <div className="bg-card rounded-xl border border-border p-4 md:p-6 lg:p-8">
      <div className="flex items-center gap-3 mb-4 md:mb-6">
        <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent/10">
          <AppIcon name="FileCode" size={20} className="text-accent" />
        </div>
        <div>
      ...
      {!hasRequiredData ? (
        <div className="flex items-center justify-center py-8 md:py-12">
          <div className="text-center">
            <AppIcon name="FileCode" size={48} className="text-muted-foreground/30 mx-auto mb-3" />
        ...
        <div className="space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="p-3 bg-muted/30 rounded-lg border border-border">
                ...
                <p className="text-sm font-semibold text-foreground">
                  ${parseFloat(loanAmount).toLocaleString('en-US', { minimumFractionDigits: 2 })} USDC
                </p>
              </div>
              <div className="p-3 bg-muted/30 rounded-lg border border-border">
          ...
          <div className="p-4 bg-primary/5 rounded-lg border border-primary/20">
            <div className="flex items-start gap-3">
              <AppIcon name="Zap" size={20} className="text-primary flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-foreground mb-2">Deployment Estimate</p>
                <div className="space-y-1 text-xs text-muted-foreground">
                  <div className="flex items-center justify-between">
                    <span>Estimated Gas Fee:</span>
                    <span className="font-medium text-foreground">{contractData.gasFee} XRP</span>
                  </div>
                  <div className="flex items-center justify-between">
          ...
          <div className="p-4 bg-success/10 rounded-lg border border-success/20">
            <div className="flex items-start gap-3">
              <AppIcon name="Shield" size={20} className="text-success flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-sm font-medium text-success mb-1">Security Features</p>
                <ul className="text-xs text-muted-foreground space-y-1">
                  <li className="flex items-center gap-2">
                    <AppIcon name="Check" size={14} className="text-success" />
