...
interface ProjectionCalculationProps {
  loanAmount: string;
  interestRate: string;
  loanTerm: string;
}

export default function ProjectionCalculation({ loanAmount, interestRate, loanTerm }: ProjectionCalculationProps) {
      ...
      <div className="bg-card rounded-xl border border-border p-4 md:p-6 lg:p-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-primary/10">
            <AppIcon name="Calculator" size={20} className="text-primary" />
          </div>
          <div>
        ...
        <div className="flex items-center justify-center py-8 md:py-12">
          <div className="text-center">
            <AppIcon name="TrendingUp" size={48} className="text-muted-foreground/30 mx-auto mb-3" />
    ...
    <div className="bg-card rounded-xl border border-border p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div className="p-4 md:p-6 bg-gradient-to-br from-success/10 to-success/5 rounded-lg border border-success/20">
          <div className="flex items-center gap-2 mb-2">
            <AppIcon name="TrendingUp" size={18} className="text-success" />
        ...
        <div className="p-4 md:p-6 bg-gradient-to-br from-accent/10 to-accent/5 rounded-lg border border-accent/20">
          <div className="flex items-center gap-2 mb-2">
            <AppIcon name="Calendar" size={18} className="text-accent" />
        ...
        <div className="p-4 md:p-6 bg-gradient-to-br from-warning/10 to-warning/5 rounded-lg border border-warning/20">
          <div className="flex items-center gap-2 mb-2">
            <AppIcon name="Percent" size={18} className="text-warning" />
